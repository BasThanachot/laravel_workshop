<div class="mx-auto flex flex-col items-center justify-center h-screen bg-gradient-to-tr from-purple-500 to-white">
    <div class="w-full max-w-md border border-purple-400 rounded-md p-4 bg-white">
