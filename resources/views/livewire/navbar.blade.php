    ...
    <div class="flex items-center justify-between">
        ...
        <div>
            <button wire:click="editProfile"
                class="border border-blue-600 text-blue-600 hover:text-white px-6 py-3 rounded-2xl mr-2">
                <i class="fa-solid fa-user-pen ms-2"></i>
                <span>แก้ไขข้อมูล</span>
            </button>

            <button wire:click="showModal = true"
                class="border border-purple-400 text-purple-400 hover:text-white px-6 py-3 rounded-2xl">
                <span>ออกจากระบบ</span>
                <i class="fa-solid fa-sign-out ms-2"></i>
            </button>
        </div>
    </div>
